...
#### **1.1 技术起源与早期发展**
  <img src="/docs/tech-NIL/1.jpg" alt="-" style="display:block; margin:auto; width:80%;" />
...
热压印是一种 **机械压印** 技术，通过 **加热聚合物材料** 使其软化，然后使用模具施加压力形成微纳结构。冷却后，图案固定在材料表面。**1995年**，华人科学家 **周郁（Stephen Chou）** 提出了 **纳米压印技术（NIL）**，其中热压印是最早的实现方式。

#### 紫外固化（UV Curing）
紫外固化是一种 **光化学固化** 技术，使用 **紫外光（UV）照射光敏聚合物** 使其发生交联反应，从而形成稳定的微纳结构。**2000年左右**，紫外固化纳米压印技术开始发展。
...
| **材料** | **特点** | **适用场景** |
|---------|---------|---------|
| **硅（Si）** | 与硅晶圆匹配，常用于半导体加工 | 半导体制造，纳米压印模板 |
| **二氧化硅（SiO₂）** | 光学透明性好，适用于精密纳米结构 | 光学器件，精密图形 |
| **碳化硅（SiC）** | 高硬度，耐磨损，适用于高耐久性应用 | 耐磨模板，高强度压印 |
| **氮化硅（Si₃N₄）** | 化学稳定性高，耐腐蚀 | 特定工艺需求，高稳定性模板 |
| **金属（镍 Ni）** | 高耐久性，可用于特定刻蚀工艺 | 金属模板，深刻蚀应用 |
| **蓝宝石（Sapphire）** | 高硬度，高透明度 | 特殊纳米压印，光学元件 |
| **金刚石薄膜（Diamond Films）** | 极高硬度，超耐久性，适用于超精密加工 | 高端纳米压印，超精密制造 |
